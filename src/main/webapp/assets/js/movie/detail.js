...
$(function(){
    ...
    $(".score_box_click").click(function(){
        ...
        for(let i = 0; i<index+1;i++){
            //0번부터 클릭된 위치의 박스까지 순차적으로 조회하며, 배경색을 오렌지 레드로 설정
    ...
    $("#modify_comment").click(function(){
        if(!confirm("평점/댓글을 수정하시겠습니까?"))return;
        let data={
            mc_seq:$(this).attr("data-seq"),
            mc_content:$("#input_comment").val(),
            mc_rate:score
            // mc_rate:$(".final_score").html()
        }
        $.ajax({
            url:"/api/movie/comment",
            type:"patch",
                ...
                '<div class="comment_item">'+
                    ...
                    '<div class="comment_content">'+
                        ...
                        '<p class="user">'+
                            ...
                            '<span class="sep">|</span>'+
                            '<span class="reg_dt">'+data.mc_mod_dt+'</span>'+
                            '<span class="sep">|</span>'+
