    ...
    <main>
        ...
        <div class="input_form">
            <div class="data_cell">
                ...
                <p class="msg duplicate">이미 사용 중인 아이디입니다.</p>
            </div>
            <div class="data_cell">
            ...
            <div class="data_cell">
                ...
                <div class="img_preview" style="height: 120px; width: 90px; background-repeat: no-repeat; background-size: auto 100%; background-position: center;">

                </div>
                <form id="profile_img_form">
                    <input type="file" id="pf_img" name="file" hidden>
                </form>
                <button id="file_sel" onclick="document.getElementById('pf_img').click()">파일 선택</button>
