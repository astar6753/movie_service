...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/account/comment.css">
    ...
    <main>
                ...
                <div class="comment_and_score">
                    <div class="info1">
                        <div class="score">
                            ...
                            <div class="progress" style="width: ${item.mc_rate}%"></div>
                        </div>
                        <div class="reg_dt">
                    ...
                    <div class="info2">
                        ...
                        <div class="like"><i class="fas fa-thumb-up"></i>
                            <span>${item.like_cnt}</span>
                        </div>
                        <div class="dislike"><i class="fas fa-thumb-down"></i>
                            <span>${item.dislike_cnt}</span>
                        </div>
                    </div>
                    <div class="buttons">
                        <button class="delete" data-seq="${item.mc_seq}">삭제</button>
                    </div>
                </div>
            </c:forEach>
        </div>
        <div class="pager_area">
            <c:forEach begin="1" end="${pageCnt}" var="i">
                <a href="/account/comment?page=${i}">${i}</a>
            </c:forEach>
        </div>
    </main>
</body>
