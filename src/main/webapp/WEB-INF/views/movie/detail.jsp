                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="sep">|</span>
                                <span><fmt:formatDate value="${data.movie_info.mi_opening_dt}" pattern="yyyy-MM-dd"/> 개봉 </span>
                            </td>
                        </tr>
                        <tr>
                            <td>출연</td>
                        ...
                        <tr>
                            <td>등급</td>
                            <td>
                                <c:if test="${data.movie_info.mi_viewing_age == 0}">전체관람가</c:if>
                                <c:if test="${data.movie_info.mi_viewing_age != 0}">${data.movie_info.mi_viewing_age}세 관람가</c:if>
                            </td>
                        </tr>
                    </table>
                </div>
